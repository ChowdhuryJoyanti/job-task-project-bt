...
const FormTwo = ({ formData }) => {
  ...
  return (
    <div>
      <div className="h-20 w-full bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ... text-white text-center">
        <h2 className="items-center text-3xl pt-5 text-white font-bold">
        Battery Low Interactive Ltd
        </h2>
      </div>
      <div className="max-w-6xl mx-auto">
        <table className="table  bg-gray-200 mt-5">
          {/* head */}
          <thead>
      ...
      <div>
        <form onSubmit={handleSubmit} className="max-w-6xl mx-auto">
          ...
          <div className="my-10 text-center">
            <button className=" btn lg:w-72 w-full  text-white px-8  bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ...">
              Submit
            </button>
          </div>
        </form>
